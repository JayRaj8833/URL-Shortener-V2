...
BOT_TOKEN = os.environ.get("BOT_TOKEN","5690405597:AAED5v6tifIwoc51juKUdi97bnEAPVscybA")  # Bot token from @BotFather
ADMINS = (
...
DATABASE_NAME = os.environ.get("DATABASE_NAME", "Tamizhmasters")
DATABASE_URL = os.environ.get(
    "DATABASE_URL", ""
)  # mongodb uri from https://www.mongodb.com/
OWNER_ID = int(os.environ.get("OWNER_ID", "960432019"))  # id of the owner
ADMINS.append(OWNER_ID) if OWNER_ID not in ADMINS else []
 
#  Optionnal variables
LOG_CHANNEL = int(
    os.environ.get("LOG_CHANNEL", "-1001961486490")
...
SOURCE_CODE = os.environ.get(
    "SOURCE_CODE", "https://jaymehta.pro"
)  # for upstream repo
